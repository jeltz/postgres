...
program_help_ok('pg_createuser');
program_version_ok('pg_createuser');
program_options_handling_ok('pg_createuser');
...
$node->issues_sql_like(
	[
		'pg_createuser', 'REGRESS_USER5', '-m', 'regress_user3',
		'-m', 'regress user #4'
	],
...
$node->issues_sql_like(
	[ 'pg_createuser', '-v', '2029 12 31', 'regress_user6' ],
...
$node->issues_sql_like(
	[ 'pg_createuser', '--bypassrls', 'regress_user7' ],
...
$node->issues_sql_like(
	[ 'pg_createuser', '--no-bypassrls', 'regress_user8' ],
...
$node->issues_sql_like(
	[ 'pg_createuser', '--with-admin', 'regress_user1', 'regress_user9' ],
	...
	'--with-admin');
$node->issues_sql_like(
	[ 'pg_createuser', '--with-member', 'regress_user1', 'regress_user10' ],
	...
	'--with-member');
$node->issues_sql_like(
	[ 'pg_createuser', '--role', 'regress_user1', 'regress_user11' ],
	...
	'--role');
$node->issues_sql_like(
	[ 'pg_createuser', 'regress_user12', '--member-of', 'regress_user1' ],
...
$node->command_fails([ 'pg_createuser', 'regress_user1' ],
	'fails if role already exists');
$node->command_fails(
	[ 'pg_createuser', 'regress_user1', '-m', 'regress_user2', 'regress_user3' ],
